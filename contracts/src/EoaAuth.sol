...
import {EoaProof} from "./interfaces/circuits/IVerifier.sol"; /// @dev - This EoaProof is imported from the Verifier.sol
...
contract EoaAuth is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function authEoa(EoaAuthMsg memory eoaAuthMsg, uint256[] calldata pubSignals) public onlyController { /// @dev - The "EoaAuthMsg" struct would include the "EoaProof proof" property, meaning that the proof (EmailProof) will be registered via this authEmail() function.
        // require(
